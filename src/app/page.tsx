  ...
  return (
    <main className="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden bg-[#f8fafc] dark:bg-neutral-950">
      ...
      <div className="max-w-4xl w-full text-center space-y-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 rounded-full shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
          ...
          <Link 
            ...
            className="flex items-center gap-2 px-8 py-4 rounded-2xl bg-white dark:bg-neutral-900 border border-gray-200 dark:border-neutral-800 text-neutral-900 dark:text-white font-black transition-all hover:bg-gray-50 dark:hover:bg-neutral-800 hover:-translate-y-1 active:translate-y-0 shadow-sm"
          >
        ...
        <div className="pt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-8 rounded-[2rem] bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800 shadow-sm">
            ...
            <h3 className="font-black text-lg mb-2">AI Scoring</h3>
          ...
          <div className="p-8 rounded-[2rem] bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800 shadow-sm">
            ...
            <h3 className="font-black text-lg mb-2">Smart Matching</h3>
          ...
          <div className="p-8 rounded-[2rem] bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-800 shadow-sm">
            ...
            <h3 className="font-black text-lg mb-2">Real-time Map</h3>
