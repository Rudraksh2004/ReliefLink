          ...
          <div className="bg-white/60 dark:bg-neutral-900/60 backdrop-blur-xl p-8 rounded-[2rem] border border-neutral-200/50 dark:border-neutral-800/50 shadow-xl shadow-neutral-100/40 dark:shadow-none">
            <div className="mb-8">
              ...
              <p className="text-neutral-500 dark:text-neutral-400 text-sm mt-1">
                Enter your credentials to manage relief coordination.
              </p>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex justify-between mb-2 pl-1">
                    ...
                    <a href="#" className="text-xs font-bold text-blue-600 dark:text-blue-400 hover:underline underline-offset-4">
                      Forgot?
                    </a>
                  </div>
                  <div className="relative group">
